...
- Enh: add multi-account support — `--email` can be specified multiple times to backup/restore multiple accounts in parallel (each account runs in a separate process)
